...
const en: Text = {
  ...
  hero: {
    ...
    stats: ['24+ SKUs', '7 categories', '48h inquiry response', 'Team sourcing'],
  },
  sections: {
...
const translations: Record<LanguageCode, Text> = {
  ...
  pt: makeText({
    ...
    hero: { badge: 'Fornecimento de futebol, volei, basquete, tenis, badminton e uniformes', title: 'Linyi Ruilan Senju', subtitle: 'Fornecedor de artigos esportivos para escolas, clubes, varejistas e eventos.', primary: 'Ver produtos', secondary: 'Solicitar cotacao', stats: ['24+ modelos', '7 categorias', 'Resposta 48h', 'Compra por equipe'] },
