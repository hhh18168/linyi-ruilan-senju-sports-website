...
const translations: Record<LanguageCode, Text> = {
  ...
  fr: makeText({
    ...
    hero: { badge: 'Fourniture de football, volley-ball, basket-ball, tennis, cricket, badminton et tenues', title: 'Linyi Ruilan Senju', subtitle: 'Fournisseur d articles de sport pour ecoles, clubs, distributeurs et acheteurs evenementiels.', primary: 'Voir les produits', secondary: 'Demander un devis', stats: ['24+ modeles', '8 categories', 'Reponse 48h', 'Achat equipe'] },
  ...
  de: makeText({
    ...
    hero: { badge: 'Lieferung von Fussball, Volleyball, Basketball, Tennis, Cricket, Badminton und Teamwear', title: 'Linyi Ruilan Senju', subtitle: 'Sportartikel-Lieferant fur Schulen, Vereine, Handler und Event-Einkaufer.', primary: 'Produkte ansehen', secondary: 'Angebot anfragen', stats: ['24+ Modelle', '8 Kategorien', 'Antwort 48h', 'Team-Einkauf'] },
  ...
  it: makeText({
    ...
    hero: { badge: 'Fornitura di calcio, pallavolo, basket, tennis, cricket, badminton e abbigliamento team', title: 'Linyi Ruilan Senju', subtitle: 'Fornitore di articoli sportivi per scuole, club, rivenditori ed eventi.', primary: 'Vedi prodotti', secondary: 'Richiedi preventivo', stats: ['24+ modelli', '8 categorie', 'Risposta 48h', 'Acquisto team'] },
  ...
  nl: makeText({
    ...
    hero: { badge: 'Levering van voetbal, volleybal, basketbal, tennis, cricket, badminton en teamkleding', title: 'Linyi Ruilan Senju', subtitle: 'Leverancier van sportartikelen voor scholen, clubs, winkels en evenementen.', primary: 'Bekijk producten', secondary: 'Offerte aanvragen', stats: ['24+ modellen', '8 categorieen', 'Reactie 48u', 'Teamaankoop'] },
  ...
  vi: makeText({
    ...
    hero: { badge: 'Cung cap bong da, bong chuyen, bong ro, tennis, cricket, cau long va do doi', title: 'Linyi Ruilan Senju', subtitle: 'Nha cung cap do the thao cho truong hoc, cau lac bo, nha ban le va su kien.', primary: 'Xem san pham', secondary: 'Yeu cau bao gia', stats: ['24+ mau', '8 danh muc', 'Phan hoi 48h', 'Mua theo doi'] },
